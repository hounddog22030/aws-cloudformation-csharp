...
namespace AWS.CloudFormation.Test.Resource.DirectoryService
{
    ...
    public class SimpleAdTest
    {
        ...
        {
            Template t = new Template("corp.getthebuybox.com", "SimplestTestVpc", $"SimplestTest{DateTime.Now.Ticks}", StackTest.CidrVpc);
            ...
            MicrosoftAd simpleAd = new MicrosoftAd("alpha.dev.yadayadasoftwarecom.awsdirectory.com", StackTest.GetPassword(),DirectorySize.Small, t.Vpcs.First(), subnet1, subnet2);
