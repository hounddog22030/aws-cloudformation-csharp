...
namespace AWS.CloudFormation.Test.Resource.DirectoryService
{
    ...
    public class SimpleAdTest
    {
        ...
        public void SimplestTest()
        {
            ...
            var simpleAd = new SimpleActiveDirectory("alpha.dev.yadayadasoftwarecom.awsdirectory.com",  "kl..1sd!jflk2", DirectorySize.SimpleSmall, t.Vpcs.First(), subnet1, subnet2);
